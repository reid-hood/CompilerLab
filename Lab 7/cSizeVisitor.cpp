...
void cSizeVisitor::Visit(cProgramNode *node)
{
...
void cSizeVisitor::Visit(cBlockNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cDeclsNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cVarDeclNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cArrayDeclNode *node)
{
    if (node == nullptr) return;
    
    // Array declarations don't have size/offset themselves
    // They just define a type that will be used in var declarations
    // No processing needed
}

void cSizeVisitor::Visit(cStructDeclNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cVarExprNode *node)
{
    if (node == nullptr) return;
...
int cSizeVisitor::ComputeSize(cDeclNode *decl)
{
...
int cSizeVisitor::AlignOffset(int offset, int size)
{
...
void cSizeVisitor::Visit(cFuncNode *node)
{
    if (node == nullptr) return;
    ...
    if (stmts != nullptr)
    {
        ...
        for (int i = 0; i < stmts->GetStmtCount(); i++)
        {
            ...
            else if (m_currentOffset > localsMaxOffset)
            {
                localsMaxOffset = m_currentOffset;
            }
        }
...
void cSizeVisitor::Visit(cArgsNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cParamsNode *node)
{
    if (node == nullptr) return;
...
void cSizeVisitor::Visit(cFuncDeclNode *node)
{
    if (node == nullptr) return;
